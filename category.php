...
$category_id = filter_input(INPUT_GET, 'category_id', FILTER_VALIDATE_INT);     // Validate id
...
<html lang="en">
    ...
    <body>
        ...
        <header class="container py-5" id="header">
            ...
            <h1><a ><?php echo $categoryone['name'] ?></a></h1>
            <p class="site-description"> <?php echo $categoryone['description'] ?> </p>
        </header>
                            ...
                            <article class="post">
                                ...
                                <main class="post-body">
                                    <div class="post-thumbnail">
                                        ...
                                        <div class="post-author">
                                            <span>by </span> <?php echo $article['member_id'] ?>
                                        </div>
                                ...
                                <footer class="post-footer row">
                                    <div class="read-more col-12 col-sm-4 text-center text-sm-left">
                                        <a href="./single.php?article_id=<?php echo $article['id'] ?>">Read more <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                    ...
                                    <div class="post-comments-number col-6 col-sm-4 text-right">
                                        <a href="./single.php?article_id=<?php echo $article['id'] ?>#comments"></a>3 Comments</a>
                                    </div>
                                </footer>
                            </article>
                        <?php } ?>
